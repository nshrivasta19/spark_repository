...
# MAGIC %fs ls 'dbfs:/FileStore/tables/bad_records/20241105T023408/bad_records/'

# COMMAND ----------

# creating a dataframe to view stored bad records 
bad_records_df = spark.read.format("json").load("dbfs:/FileStore/tables/bad_records/20241105T023408/bad_records/")
